...
def echo_all(message):
    if message.text == "Начнем сначала?":
        ...
        bot.send_message(message.chat.id, "Я не всасываю что ты пишешь! Давай жми /start", reply_markup=markup_menu)
